<template>
  <div class="friend-data">
    <div class="friend" id="friend">
      ...
      <!-- <p class="star-infor">
        <img src="@/assets/teacher/老师头像.png" alt="">
        <span>
          <p>万老师</p>
          <p>太阳花小学</p>
          <p>一年级</p>
        ...
        <span>共享练习2965份</span>
        <span><a-rate disabled :count="1" v-model="value"></a-rate></span>
      </p>
      <p class="star-infor">
        <img src="@/assets/teacher/老师头像.png" alt="">
        <span>
        ...
        <span>共享练习2965份</span>
        <span class="cur"><a-rate disabled :count="1" v-model="value"></a-rate></span>
      </p> -->
      </div>
      <!-- 好友列表 -->
            ...
            <ul class="clearfix">
              <li v-for="(item,index) in teacherList" :key="index">
                ...
                <p v-for="(i,j) in item.FriendList" :key="j" @mouseenter="enterMouse(i.FriendsId)" @mouseleave="leave(i.FriendsId)"><img src="@/assets/teacher/老师头像.png" alt="">&nbsp;&nbsp;&nbsp;&nbsp; <span>{{ i.RealName }}</span><span>共享练习{{ i.PracticeCount }}份</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <!-- <span v-show="i.Deleted === 0" class="mutual-friend cur">互为好友</span>
                <span v-show="i.Deleted === 1" class="add-friends cur">加好友</span>
                <span v-show="i.Deleted === 2" class="under-review cur">申请中</span> -->
                  <span @click="handleStarFriends(i.FriendsId,i.Interstellar)" class="star-num" :class="{'color': i.Interstellar === '1'}" >☆</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <!-- <span @click="addStarFriend(i.FriendsId)" class="cur" v-show="i.Interstellar === '0'">☆</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
